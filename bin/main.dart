import 'package:dart_application_1/bubble_sort.dart';

// void main() {
//   final word = 'localization';
//   final words = abbrevation(word);
//   print(words);
// }

// String abbrevation(String word) {
//   var newWord = '';
//   if (word.length > 10) {
//     newWord = newWord + word[0];
//     newWord = newWord + (word.length - 2).toString();
//     newWord = newWord + (word[word.length - 1]).toString();
//     return newWord;
//   }
//   return word;
// }
...
void main() {
  ...
  final map = makeTextIntoMap(lowercase);
  final list = convertMapToList(map);
  sortList(list);
  // print(list);

  final userInput = [18, 8, 17, 7];
  final suggestedWords = findWordsForCode(userInput, list);
  print(suggestedWords); //such
}
...
// look -> [18, 8, 17]
  ...
  final codelist = <int>[];
  var oldLetter = '';
  for (var charCode in word.codeUnits) {
